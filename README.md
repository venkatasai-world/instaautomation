...
<img src="post.jpg" height="300" width="200" style="display:block; margin: 0 auto; border-radius:12px; box-shadow:0 8px 25px rgba(0,0,0,0.25);">

Every post you see above is automatically created — the quote, the image design, the caption, and the hashtags — then posted directly to Instagram without any human intervention.

Powered by **Python, Gemini API, SQLite, GitHub Actions, Instagrapi, and Pillow**, this project transforms ideas into scalable systems and consistency into a daily habit.
